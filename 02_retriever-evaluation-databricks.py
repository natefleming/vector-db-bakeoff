...
vector_stores = model_config.get("vector_stores")
databricks_vector_store = vector_stores.get("databricks")
options = databricks_vector_store.get("options")
endpoint: str = options.get("endpoint")
index_name: str = options.get("index_name")
columns: List[str] = options.get("columns")

databricks_vs: VectorStore = (
  DatabricksVectorSearch(endpoint=endpoint, index_name=index_name, columns=columns)
)
